# Copyright (C) 2019 the ELiteOS Project
#
...
ifeq ($(TARGET_BOOT_ANIMATION_RES),720)
     ...
     PRODUCT_COPY_FILES += vendor/elite/prebuilt/bootanimation/1440/bootanimation.zip:system/media/bootanimation.zip
else
     $(warning TARGET_BOOT_ANIMATION_RES is invalid or undefined, using generic bootanimation)
     PRODUCT_COPY_FILES += vendor/elite/prebuilt/bootanimation/bootanimation.zip:system/media/bootanimation.zip
endif
